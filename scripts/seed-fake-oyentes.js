...
async function seedFakeOyentes() {
    ...
    try {
        for (const oyente of fakeOyentes) {
            ...
            console.log(`   ✓ 42 horarios creados (7 días × 6 horas)`);
        }

        console.log("\n✅ ¡Perfiles falsos creados exitosamente!");
        console.log("\n📊 Resumen:");
        console.log("   • María López García - 15€ (Ansiedad y Estrés)");
        console.log("   • Carlos Martínez Ruiz - 20€ (Relaciones y Autoestima)");
        console.log("   • Laura Fernández Sánchez - 35€ (Bienestar Emocional)");
        console.log("\n🔔 Sistema de notificación activado:");
        console.log("   Cuando alguien intente comprar, verás un mensaje en los logs del servidor");
