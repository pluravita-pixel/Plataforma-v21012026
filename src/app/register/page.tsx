        ...
        >
            <span className="relative z-10 flex items-center justify-center gap-2">
                {pending ? (
                    ...
                    <>
                        Crear mi cuenta
                        <UserPlus className="h-5 w-5 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </>
                )}
            </span>
        </Button>
                    ...
                    <div className="w-full lg:w-2/5 p-6 sm:p-12 lg:p-20 flex flex-col justify-center bg-white/60 backdrop-blur-md relative z-10 my-auto">
                        <div className="w-full max-w-md mx-auto space-y-8 lg:space-y-8 pt-12 lg:pt-0">
                            ...
                            <form action={formAction} className="space-y-5">
                                ...
                                <div className="space-y-1.5 group focus-within:transform focus-within:translate-x-1 transition-transform duration-300">
                                    <Label htmlFor="password" className="text-[13px] uppercase tracking-wider font-bold text-[#A68363] ml-1 opacity-80 group-focus-within:opacity-100 transition-opacity">Contraseña</Label>
                            ...
                            <p className="text-xs text-center text-gray-400 px-6">
                                Al registrarte, aceptas nuestros <Link href="#" className="font-bold hover:text-gray-600 underline">Términos de servicio</Link> y <Link href="#" className="font-bold hover:text-gray-600 underline">Política de privacidad</Link>.
                            </p>
