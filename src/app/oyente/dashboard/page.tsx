...
export default async function PsychologistDashboard() {
    ...
    const stats = [
        { label: "Usuarios Activos", value: data.psych.activeUsers?.toString() || "0", icon: Users, color: "bg-[#4A3C31]/10 text-[#4A3C31]" },
        ...
        { label: "Total Usuarios", value: data.psych.totalUsers?.toString() || "0", icon: MessageSquare, color: "bg-orange-50 text-orange-700" },
    ];
