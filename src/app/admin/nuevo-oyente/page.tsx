        ...
        <div className="max-w-4xl">
            <div className="mb-12">
                ...
                <p className="text-gray-500 mt-4 text-lg max-w-2xl leading-relaxed">
                    Crea un perfil profesional en la base de datos. El sistema habilitará automáticamente el acceso de oyente para este correo electrónico.
                </p>
            </div>
